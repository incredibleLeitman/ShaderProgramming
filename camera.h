...
public:
    ...
    {
        // TODO: include from common.h or set in ctor
        return glm::perspective(glm::radians(Zoom), 1024.0f / 800.0f, 0.1f, 500.0f);
    }
    ...
    void ProcessMouseMovement (float xoffset, float yoffset, /*GLboolean*/ unsigned char constrainPitch = true)
    {
        ...
        std::cout << "current camera values: \nx,y: " << xoffset << ", " << yoffset << "\n" <<
